...
export default {
  ...
  methods: {
    submitForm() {
      axios
        .get("http://165.22.130.92/replay/" + this.testID, {
          method: "GET",
          mode: "cors",
          cache: "no-cache",
          headers: {
